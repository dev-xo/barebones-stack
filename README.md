...
- Create a new [GitHub Repository](https://repo.new). **Do not push your app yet!**

```sh
# Initialize Git on your workspace:
git init

# Add the newly created repository as remote for your project.
# Remember: Do not push it yet!
...
```sh
# Add a `SESSION_SECRET` to your fly app secrets, running the following commands:
...
Now that everything is set up you can **add, commit and push** your changes to your repo. Every commit to your `main` branch will trigger a deployment to your production environment, and every commit to your `dev` branch will trigger a deployment to your staging environment.
