			...
			{user && (
				<footer className="flex w-auto flex-row items-center justify-center py-4">
					<a
						...
						transition hover:scale-105 hover:opacity-100 active:scale-100">
						<svg
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="active:scale-1000 flex h-12 flex-row items-center text-lg font-semibold text-gray-800
						opacity-40 transition hover:scale-105 hover:opacity-100">
						<svg
							className="h-8 fill-gray-800"
							viewBox="0 0 24 24"
							xmlns="http://www.w3.org/2000/svg">
