...
export const meta: MetaFunction = () => {
	return {
		title: 'Barebones Stack - Sign Up with Email',
	}
}
	...
	return (
		<div className="relative flex w-full max-w-md flex-col">
				...
				<fieldset>
					...
					<label className="font-semibold text-gray-800">
						...
						<input
							...
							className="flex h-12 w-full rounded-xl border-2 border-gray-500 bg-transparent
            	px-4 text-base font-semibold text-black transition"
						/>
			...
			<div className="flex flex-row justify-end">
				<Link
					className="font-semibold text-gray-800 hover:opacity-60"
					to="/login/email">
