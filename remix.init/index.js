 ...
 */
async function cleanupVitestConfigFile(rootDirectory) {
 ...
 */
async function cleanupDeployWorkflowFile(rootDirectory) {
 ...
 * with provided variables from `.env.example`.
 */
async function replaceAndInitEnvFiles(rootDirectory) {
